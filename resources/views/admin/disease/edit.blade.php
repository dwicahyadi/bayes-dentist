            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-white">
                        <span class="card-title">Form Edit Penyakit</span>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('disease.update', $disease) }}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input id="value" type="number" class="form-control @error('value') is-invalid @enderror" name="value" value="{{ old('value') ?? $disease->value }}" required step="0.01">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea id="description" rows="10" class="form-control @error('description') is-invalid @enderror" name="description" required>{{ old('description') ?? $disease->description }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea id="advice" rows="10" class="form-control @error('advice') is-invalid @enderror" name="advice" required>{{ old('advice') ?? $disease->advice }}</textarea>
